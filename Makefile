...
syntax:
	bash -n bin/devbox lib/devbox.sh scripts/bootstrap-mac.sh scripts/bootstrap-wsl.sh scripts/bootstrap-wsl-user.sh scripts/install-pairing-helper.sh scripts/install-pairing-helper-wsl.sh scripts/pair-wsl.sh tests/config_test.sh tests/security_controls_test.sh
...
shellcheck:
	shellcheck -x -P SCRIPTDIR bin/devbox lib/devbox.sh scripts/bootstrap-mac.sh scripts/bootstrap-wsl.sh scripts/bootstrap-wsl-user.sh scripts/install-pairing-helper.sh scripts/install-pairing-helper-wsl.sh scripts/pair-wsl.sh tests/config_test.sh tests/security_controls_test.sh
